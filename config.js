module.exports = {
  autoTrade: false, // Set to true to enable automatic trading
  ...
  maxPositions: 3,
  spread: 0.2,
  minSpreadForLifetime: 2.0, // Minimum spread % to track lifetime (ignore spreads below this after 60s)
  minLifetimeSeconds: 60, // Don't notify if spread < minSpreadForLifetime and lifetime > this
  coinsVolume: 1000000,
  confirmationCount: 2,
  cooldown: 5000,
  fee: 0.1,
